    ...
    public function cargarVapPyme($version): bool
    {
        ...
        try {
            ...
            for ($i = $filaInicio; $i < $nFilas; $i++) {
                ...
                $dxcPvpTpPorta = Utilidades::codificarUTF(addslashes($hojaActiva->getCell($columnaDxcPvpTpPorta . $i)));
                $dxcVapTpPorta = Utilidades::codificarUTF(addslashes($hojaActiva->getCell($columnaDxcVapTpPorta . $i)));
