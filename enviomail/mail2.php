...
$r = $c->query("call robot_obtener_mail(1);");
if ($r->num_rows > 0) {
...
if ($procesarCorreo) {
    for($i = 0; $i < count($r); $i++){
        ...
        try {
            ...
            //Authentication
            $mail->Username = "til638c";
            $mail->Password = "Coral1826";

            //Set Params
            $mail->setFrom("info@waspapp.com.es", 'Comunicaciones WaspApp');
            ...
            if (!$mail->Send()) {
                ...
                echo "Correo ".$i." enviado info@waspapp.com.es\n\r";
            }
