<?php
try {
    // $conexion = new mysqli('127.0.0.1', 'root', 'flavio1234', 'cronos_g', 3307);
    ...
    foreach ($crms_id as $crm) {
        ...
        foreach ($fichajes as $fichaje) {
            ...
            if ($tipo_horario === "fijo") {
                ...
                $segundos_diferencia = abs($salida->getTimestamp() - $horaActual->getTimestamp());


                if ($segundos_diferencia <= 59) { // Si faltan 59 segundos o menos para la salida
